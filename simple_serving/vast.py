...
on that instance. The card's own key cannot stand in: Vast refuses it from outside the card. The command has no stop
of its own: only the gateway stops the card, after its drain.
